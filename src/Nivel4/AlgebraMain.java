...
public class AlgebraMain extends JFrame implements GLEventListener, KeyListener, MouseListener, MouseMotionListener
{
    ...
    Texture texturaVestido;Textura textura = new Textura();
    Sonido sonido=new Sonido();
    final GLCanvas canvas = new GLCanvas();
    JFrame  jframe;
    MrsAlgebra mrsAlge;
    PuntajeF pu;
    public AlgebraMain(PuntajeF pu)
    {
        this.pu=pu;
    }
     public void mainAlgebra()
    {
        jframe = new JFrame("Mrs Algebra");
        GLCanvas canvas = new GLCanvas();
        canvas.addGLEventListener(new AlgebraMain(pu));
        jframe.add(canvas);
        jframe.setSize(850, 700);

        final Animator animator = new Animator(canvas);
        jframe.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        jframe.setLocation(490, 0);
    ...
    public void init(GLAutoDrawable drawable)
    {
        ...
        try{
            texturaVestido = TextureIO.newTexture (new File("src/Nivel4/Biblioteca-del-MAC-Barcelona_slider_big.jpg"), true);
        }catch (IOException e)
        {
    ...
    public void display(GLAutoDrawable drawable)
    {
        ...
        MrsAlgebra stan = new MrsAlgebra (pu);
    ...
    @Override
     public void keyReleased(KeyEvent e) {      
        ...
        try {
            ...
            sounds = new FileInputStream(new File("sounds/" + salta + ".wav"));
